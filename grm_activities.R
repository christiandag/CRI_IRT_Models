### Innovation Activities construct analysis using GRM model ###
...
# Select the columns corresponding to Innovation Activities items
ddd<-ddd[,14:22]
...
latent_trait_tech <- fscores(mod.pcm, method="EAP", full.scores=T, full.scores.SE = T, response.pattern=tech[,14:22])
...
hist(latent_trait_tech, main = "Innovation activities", ylab = "Frequency", xlab="Latent trait", 
